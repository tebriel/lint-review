...
class ReviewConfigTest(TestCase):
    ...
    def test_getitem(self):
        ...
        self.assertEqual(app_config['SUMMARY_THRESHOLD'], config['SUMMARY_THRESHOLD'])

    @staticmethod
    def test_getitem__error():
        config = build_review_config(simple_ini, app_config)
    ...
    def test_get(self):
        config = build_review_config(simple_ini, app_config)
        self.assertEqual(app_config['SUMMARY_THRESHOLD'], config.get('SUMMARY_THRESHOLD'))
