...
class TestInit(TestCase):
    ...
    def test_apply_fixer_diff__missing_strategy_key(self):
        ...
        with pytest.raises(fixers.ConfigurationError) as err:
            fixers.apply_fixer_diff(original, changed, context)
        self.assertIn('Missing', err.exconly())
    ...
    def test_apply_fixer_diff__invalid_strategy(self):
        ...
        with pytest.raises(fixers.ConfigurationError) as err:
            fixers.apply_fixer_diff(original, changed, context)
        self.assertIn('Unknown', err.exconly())
    ...
    def test_apply_fixer_diff__missing_strategy_context(self):
        ...
        with pytest.raises(fixers.ConfigurationError) as err:
            fixers.apply_fixer_diff(original, changed, context)
        self.assertIn('Could not create commit workflow', err.exconly())
    ...
    def test_create_context(self):
        ...
        self.assertEqual(config['GITHUB_AUTHOR_EMAIL'], context['author_email'])
