...
class TestCheckstyle(TestCase):
    ...
    def test_process_files__multiple_error(self):
        ...
        expected = Comment(
            ...
            1,
            1,
            "Missing a Javadoc comment. (com.puppycrawl.tools.checkstyle.checks.javadoc.JavadocTypeCheck)\n"
        ...
        expected = Comment(
            ...
            3,
            3,
            "Missing a Javadoc comment. (com.puppycrawl.tools.checkstyle.checks.javadoc.JavadocMethodCheck)\n"
            "Parameter args should be final. (com.puppycrawl.tools.checkstyle.checks.FinalParametersCheck)"
        )
