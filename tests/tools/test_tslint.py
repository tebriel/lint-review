...
class TestTslint(TestCase):
    ...
    def test_process_files__fail(self):
        ...
        msg = ("Shadowed name: 'range' (failure.tslint.no-shadowed-variable)\n"
               "Spaces before function parens are disallowed (failure.tslint.space-before-function-paren)")
    ...
    def test_process_files_with_config(self):
        ...
        msg = "The key 'middle' is not sorted alphabetically (failure.tslint.object-literal-sort-keys)"
    ...
    def test_process_files__unknown_module(self):
        ...
        error = problems[0]
        self.assertIn('Your tslint configuration output the following error:', error.body)
