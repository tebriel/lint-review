...
class Testphpcs(TestCase):
    ...
    def test_process_files__with_config(self):
        ...
        self.assertEqual(3, len(problems), 'Changing standards changes error counts')
    ...
    def test_process_files__with_ignore(self):
        ...
        self.assertEqual(0, len(problems), 'ignore option should exclude files')
    ...
    def test_process_files__with_exclude(self):
        ...
        self.assertEqual(1, len(problems), 'exclude option should reduce errors.')
    ...
    def test_process_files__with_invalid_exclude(self):
        ...
        self.assertEqual(1, len(problems), 'A failure comment should be logged.')

        error = problems[0].body
        self.assertIn('Your PHPCS configuration output the following error', error)
