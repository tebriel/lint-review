...
class TestDiff(TestCase):
    ...
    def test_parse_diff__headers_removed(self):
        ...
        self.assertEqual(None, change[0].commit, 'No commit as changes are just a diff')
    ...
    def test_parse_diff__multiple_files(self):
        ...
        self.assertEqual(['lintreview/git.py', 'tests/test_git.py'], out.get_files())
...
class TestDiffCollection(TestCase):
    ...
    def test_parsing_diffs_removed__file(self):
        ...
        self.assertEqual(0, len(changes), 'Should be no files as the file was removed')
...
class TestDiff(TestCase):
    ...
    def test_properties(self):
        self.assertEqual("View/Helper/AssetCompressHelper.php", self.diff.filename)
